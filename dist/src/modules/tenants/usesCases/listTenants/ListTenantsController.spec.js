...
var connection;
describe('Create List All Tenants', function () {
    //roda antes de tudo
    ...
    it('Should be able to list all cities', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.app).get('/tenants')];
                case 3:
                    response = _a.sent();
