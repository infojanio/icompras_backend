...
var CitiesRepository = /** @class */ (function () {
    ...
    CitiesRepository.prototype.findByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var city;
    ...
    CitiesRepository.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cities;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CitiesRepository.prototype.listById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var citiesQuery, city;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        citiesQuery = _a.sent();
                        return [4 /*yield*/, citiesQuery.getOneOrFail()];
                    case 2:
                        city = _a.sent();
                        return [2 /*return*/, city];
                }
    ...
    CitiesRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var city;
            return __generator(this, function (_a) {
                switch (_a.label) {
