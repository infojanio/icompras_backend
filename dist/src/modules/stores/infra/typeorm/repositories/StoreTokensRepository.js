...
var UsersTokens_1 = require("../entities/UsersTokens");
var UsersTokensRepository = /** @class */ (function () {
    function UsersTokensRepository() {
        this.repository = typeorm_1.getRepository(UsersTokens_1.UserTokens);
    }
    ...
    UsersTokensRepository.prototype.findUserByIdAndRefreshToken = function (user_id, refresh_token) {
        return __awaiter(this, void 0, void 0, function () {
            var usersTokens;
            return __generator(this, function (_a) {
                switch (_a.label) {
