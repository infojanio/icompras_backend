...
var ProductsRepository = /** @class */ (function () {
    ...
    ProductsRepository.prototype.create = function (_a) {
        var name = _a.name, description = _a.description, brand = _a.brand, category_id = _a.category_id, daily_rate = _a.daily_rate, fine_amount = _a.fine_amount, license_plate = _a.license_plate, specifications = _a.specifications, id = _a.id;
    ...
    */
    ...
    ProductsRepository.prototype.findAvailable = function (brand, name, category_id) {
        return __awaiter(this, void 0, void 0, function () {
            var carsQuery, products;
