...
var listAvailableProductsUseCase;
...
describe('List Products', function () {
    beforeEach(function () {
        ...
        listAvailableProductsUseCase = new ListAvailableProductsUseCase_1.ListAvailableProductsUseCase(productsRepositoryInMemory);
    });
    //Deve ser possível listar todos os carros disponíveis
    it('should be able to list all available products', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    product = _a.sent();
                    return [4 /*yield*/, listAvailableProductsUseCase.execute({})];
                case 2:
                    products = _a.sent();
    ...
    it('should be able to list all available products by subcategory', function () { return __awaiter(void 0, void 0, void 0, function () {
        var product, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, productsRepositoryInMemory.create({
