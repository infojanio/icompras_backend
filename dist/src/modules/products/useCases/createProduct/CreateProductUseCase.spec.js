...
describe('Create Product', function () {
    beforeEach(function () {
        ...
        createProductUseCase = new CreateProductUseCase_1.CreateProductUseCase(productsRepositoryInMemory);
    });
    ...
    it('should be able to create a new car', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createProductUseCase.execute({
                        name: 'Name Product',
    ...
    it('should not be able to create a car with exists license plate', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(createProductUseCase.execute({
                            name: 'Car 2',
                            description: 'Name Car',
                            daily_rate: 100,
                            license_plate: 'ABC-1234',
