...
var connection;
describe('Create List All SubCategory', function () {
    //roda antes de tudo
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent(); //criação da migration
                    id = uuid_1.v4();
                    return [4 /*yield*/, bcrypt_1.hash('admin', 8)];
                case 3:
                    password = _a.sent();
                    //seed de criação de usuário via SQL puro, na mão
                    return [4 /*yield*/, connection.query("INSERT INTO USERS(id, name, email, password, \"isAdmin\", created_at, driver_license) values\n      ('" + id + "', 'admin', 'admin@rentlx.com.br', '" + password + "', true, 'now()', 'xxxxxxxx' ) ")];
                case 4:
                    //seed de criação de usuário via SQL puro, na mão
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('Should be able to list all subcategories', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.app).get('/subcategories')];
                case 3:
                    response = _a.sent();
