...
var ProductsRepositoryInMemory = /** @class */ (function () {
    ...
    ProductsRepositoryInMemory.prototype.create = function (_a) {
        var name = _a.name, description = _a.description, brand = _a.brand, category_id = _a.category_id, daily_rate = _a.daily_rate, fine_amount = _a.fine_amount, license_plate = _a.license_plate, id = _a.id;
    ...
    ProductsRepositoryInMemory.prototype.findByLicensePlate = function (license_plate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.products.find(function (product) { return product.license_plate === license_plate; })];
            });
        });
    };
    ProductsRepositoryInMemory.prototype.findAvailable = function (category_id, brand, name) {
        return __awaiter(this, void 0, void 0, function () {
            var Allproducts;
            return __generator(this, function (_a) {
